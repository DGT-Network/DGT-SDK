...
from dgt_coin.processor.handler import DGT_ADDRESS_PREFIX,FAMILY_NAME,FAMILY_VER
from dgt_coin.processor.handler import make_dgt_address
 
  
class DgtMessageFactory:
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name=FAMILY_NAME,
            family_version=FAMILY_VER,
            namespace=DGT_ADDRESS_PREFIX,
            signer=signer)
    ...
    def _create_txn(self, txn_function, verb, name, value):
        ...
        addresses = [make_dgt_address(name)]
