...
function upCluster1 {
  ...
  for node in $@;do
    ...
    case $node in
        1)
          export COMPOSE_PROJECT_NAME=1 G=$GENESIS C=c1 N=1 API=8808 COMP=4104 NET=8101 CONS=5051;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        2)
          export COMPOSE_PROJECT_NAME=2 G=$GENESIS C=c1 N=2 API=8809 COMP=4106 NET=8102 CONS=5052;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        3)
          export COMPOSE_PROJECT_NAME=3 G=$GENESIS C=c1 N=3 API=8810 COMP=4107 NET=8103 CONS=5053;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        4)
          export COMPOSE_PROJECT_NAME=4 G=$GENESIS C=c1 N=4 API=8811 COMP=4108 NET=8104 CONS=5054;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        5)
          export COMPOSE_PROJECT_NAME=5 G=$GENESIS C=c1 N=5 API=8812 COMP=4109 NET=8105 CONS=5055;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        6)
          export COMPOSE_PROJECT_NAME=6 G=$GENESIS C=c1 N=6 API=8813 COMP=4110 NET=8106 CONS=5056;docker-compose -f bgx/docker/docker-compose-netCN-dgt-rest.yaml $mode
        ;;
        *)
